    ...
    return <Fragment>
        ...
        <form className="form" onSubmit={e => onSubmit(e)} action="create-profile.html">
            ...
            <div className="form-group">
                <input type="email" placeholder="Email Address" name="email" value={email} onChange={e => onChange(e)} required />            </div>
        ...
        <p className="my-1"> Already have an account? <Link to="/register">Sign Up</Link> </p>
    </Fragment>
}
